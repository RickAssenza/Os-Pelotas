...
public class PainelChama : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if(portugues == true)
        {
            ...
            text02.text = ("Nessa ilha há um grupo de 6 amigos, mais conhecidos como Os Pelotas. Os Pelotas sao um grupo de 6 amigos, Joseca, Tuco Maluco, Cardicio Maudoso, Rodrigo Vacchi, Lucicrazy e Peter People. Eles sempre estão discutindo, brigando e falando sem parar. Mas nunca se separam, se amam como irmãos, apesar de nunca admitirem. Eles treinavam muito na academia, mas não mudavam a aparência, isso é pela a genética que possuíram depois de terem entrado em uma piscina que era usada para testes químicos. Por isso a aparencia de criança e rosto desenvolvido. Joseph com a calvicie, todos eles com a arcada dentária de um adulto, alem de proezas e habilidades inexplicáveis (como por exemplo tirar 11 em uma prova que vale 10 ou dar mergulhos de cabeca em poças rasas e mergulharem profundamente sem se machucar).");
        ...
        {
            text01.text = ("En un planeta, solo había océano y un ángel gigante, de los colosales titanes que habitaban este planeta, más conocidos como Luiz Anthonio Zerbinato y Alessandro Lombardi Crisostomo. Ambos pensaron que estaban solos en este planeta y en la incesante búsqueda del ángel terminaron encontrándolo. trayendo y al mismo tiempo empezamos a comer el ajo. Sin embargo, era tan grande que no vinieron. Cada uno estaba de un lado, devorando el ajo. En el momento en que se acercaban a la mitad de la mano, se encontraron y comenzaron a pelear, peleando en lo que se conoció como 'la pelea que crea todo', ambos lanzaron golpes simultáneos y cayeron alrededor del resto de la mano, por coincidencia. cayeron en la posición exacta para formar el acto completo, dando paso a Isla Bina.");
            
            text02.text = ("En esta isla hay un grupo de 6 amigos, más conocidos como Os Pelotas. Pelotas somos un grupo de 6 amigos, Joseca, Antioco Loco, Cardicio Maudoso, Rodrigo Vacchi, Lucicrazy y Peter People. Siempre están discutiendo, peleando y hablando sin parar. Pero nunca se separan, se aman como hermanos, a pesar de no admitirlo nunca. Entrenaron mucho en el gimnasio, pero no cambiaron su apariencia, eso se debe a la genética que poseían después de ingresar a una piscina que se usaba para pruebas químicas. Es por eso que la apariencia de un niño y una cara desarrollada. Joseph con calvicie, todos ellos con el arco dental de un adulto, además de proezas y habilidades inexplicables (como sacar 11 en una prueba que vale 10 o tirarse de cabeza en charcos poco profundos y sumergirse profundamente sin lastimarse).");
